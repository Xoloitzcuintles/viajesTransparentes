                            ...
                            <div class="tab-content">
                                ...
                                <div id="infotravel" class="tab-pane fade">
                                    ...
                                    <div class='input-group date'>
                                        ...
                                        placeholder="Institución que Genera" 
                                            ...
                                            <div id="collapsePasajes" class="accordion-body collapse">
                                                <div class="accordion-inner">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="companiaPasajeIda" id="companiaPasajeIda" placeholder="Compañía" 
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="cubrePasajeRegreso" id="cubrePasajeRegreso" placeholder="Institución que cubre pasaje" 
